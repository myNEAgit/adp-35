...
var data = (function () {
    var t = function (t, a) {
            var n = e(t, a);
            $("#billions").text(n.valueBillions), $("#percent").text(n.valuePercent.replace(/0%$/g, "%")), $("#employment").text(util.numberWithCommas(n.employment)), $("#compensation").text(n.compensation.trim().replace(/0$/g, "") + "B");
        },
        e = function (t, e) {
